  ...
  return (
    <div className="mt-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-black">Why Battery Recycling Matters</h2>
        <p className="mt-4 text-lg text-BL-300">
      ...
      <div className="mt-10">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-6 text-xl font-medium text-black text-center">Sustainable Resource Recovery</h3>
            <p className="mt-2 text-base text-black-300 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-6 text-xl font-medium text-black text-center">Economic Value</h3>
            <p className="mt-2 text-base text-black-300 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="mt-6 text-xl font-medium text-black text-center">Environmental Protection</h3>
            <p className="mt-2 text-base text-black-300 text-center">
